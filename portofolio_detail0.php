                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <?php
                                $folder_foto = 'admin/foto_portofolio'; // Ganti dengan path menuju folder foto Anda
                                $id_kategori = $result['id_foto_portofolio'];
                                ...
                                ?>
                                    <div class="col-md-4 mb-5">
                                        <img src="<?php echo $image; ?>" alt="Foto_Portofolio" class="img-fluid img-thumbnail" style="width: 700%;">
                                    </div>
                                <?php
                                    $count++;
                                }
